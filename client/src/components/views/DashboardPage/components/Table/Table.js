      ...
      <Table className={classes.table} aria-label="customized table">
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="right">Buyer/Seller</StyledTableCell>
        ...
        <TableBody>
          {data.map(({
            id, title, description, date, category, basePrice, status, buyer, seller }) => (
            <StyledTableRow key={id}>
              ...
              <StyledTableCell align="right">
                {(seller && seller.email) || (buyer && buyer.email) || <p>N/A</p> }
              </StyledTableCell>
